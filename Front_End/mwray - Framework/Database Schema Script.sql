...
/*Use this to add users for debugging and development purposes*/
INSERT INTO users (userID, username, usertype, firstname, lastname, passhash)
VALUES(
	4352,
	'user',
    0,
...
/*Use this to show all users in the users table*/
SELECT * FROM users;
